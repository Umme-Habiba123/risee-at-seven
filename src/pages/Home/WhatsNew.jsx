...
const POSTS = [
  {
    ...
    author: "Ray Saddiq",
    authorAvatar:
      "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&q=90",
    readTime: "3 mins",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1486325212027-8081e485255e?w=800&q=90",
  },
  {
    id: 2,
    category: "News",
    author: "Carrie Rose",
    authorAvatar:
      "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=80&q=90",
    readTime: "2 mins",
    title: "Ryan McNamara Is Now Rise at Seven's Global Operations Director",
    image:
      "https://images.unsplash.com/photo-1515187029135-18ee286d815b?w=800&q=90",
  },
  {
    id: 3,
    category: "SEO",
    ...
    readTime: "4 mins",
    title:
      "Why LLM Search Is the Most Important Channel You're Not Investing In",
    image:
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1555215695-3004980ad54e?w=800&q=90",
  },
  {
    id: 5,
    category: "PR",
    ...
    image:
      "https://images.unsplash.com/photo-1557804506-669a67965ba0?w=800&q=90",
  },
];
...
function ExploreBtn({ fullWidth }) {
  return (
    <a
      href="#"
      className="flex items-center justify-between gap-1.5 rounded-full bg-white border border-black/10 text-neutral-900 hover:bg-neutral-900 hover:text-white hover:border-neutral-900 font-semibold shadow-sm transition-all duration-200"
      style={{
        fontFamily: "'DM Sans', sans-serif",
        fontSize: "clamp(0.78rem, 1.4vw, 0.875rem)",
        padding: "clamp(0.55rem, 1.2vw, 0.65rem) clamp(1rem, 2vw, 1.25rem)",
        whiteSpace: "nowrap",
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="hidden lg:flex items-center justify-between gap-4 border-b border-black/20 mb-10"
          style={{
            padding: "0 clamp(1rem, 5vw, 5rem) clamp(1.25rem, 3vw, 2rem)",
          }}
        >
          <h2
            className="flex flex-wrap md:flex-nowrap items-center gap-2 font-semibold text-neutral-900 leading-none max-w-[220px] md:max-w-none"
            style={{
          ...
          <ExploreBtn fullWidth={false} />
        </div>

        {/* ── MOBILE + MD HEADER ── */}
        <div
          className="flex lg:hidden items-center justify-between gap-3 border-b border-black/20 mb-6"
          style={{
            padding: "0 clamp(1rem, 5vw, 1.5rem) clamp(1rem, 2.5vw, 1.5rem)",
          }}
        >
          <h2
            className="inline-flex items-center gap-3 font-semibold text-neutral-900 leading-none"
            style={{
          ...
          {/* button: hidden on xs/sm, visible on md+ (below lg) */}
            ...
            {POSTS.map((_, i) => (
              <div
                ...
                style={{
                  ...
                  background:
                    i === activeIndex ? "#0a0a0a" : "rgba(0,0,0,0.18)",
                }}
              />
            ))}
          </div>

          {/* Explore button — full width, below carousel — only on xs/sm */}
          <div
            className="block sm:hidden"
            style={{ padding: "1.5rem clamp(1rem, 5vw, 2rem) 0" }}
          >
            <ExploreBtn fullWidth={true} />
          </div>
        </div>
